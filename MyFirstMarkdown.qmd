...
```{r question9}
## The datasets are too small and were not randomly selected which skews the data. There are also other variables that aren't represened from the original data.
```
